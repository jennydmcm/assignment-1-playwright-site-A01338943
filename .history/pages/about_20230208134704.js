            ...
            <div className={styles.body}>
              ...
              <div className={styles.infosesh}>
                ...
                <p className={styles.mainText}>
                  ...
                  step along your career path. <br></br>
                  Learn more about the programs that interests you.
                </p>
                <h3 className={styles.bigInfo}>Big Info</h3>
                <p className={styles.mainText}>
                  Big info is the largest program expo and information session
                  at BCIT. It's your chance to find<br></br>
                  out about all our programs - from business, computing, and
                  health to engineering, trades,<br></br>
